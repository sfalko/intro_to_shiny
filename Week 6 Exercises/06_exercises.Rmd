...
[here's my app!](https://sfalko.shinyapps.io/week_6_shinyapp/)
...
#fake_garden %>% subset(select = -c('This is my awesome data!')) %>% 
  head(fake_garden)
```
...
```{r}
Groceries_dataset <- read_csv("/home/sfalkovi@macalester.edu/Week 6 Shinyapp/Week 6 Exercises/Groceries_dataset.csv")
...
t <- garden_harvest %>% 
  ...
  labs(x = "weight (lbs)", y = "  ", title = "Tomato Harvest by 
       Variety") +
